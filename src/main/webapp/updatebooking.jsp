  ...
  <div class="content-wrapper">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item"><a href="./AdminController?action=view&bookId=">Booking Record List</a></li>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="ic" value='<c:out value="${customers.custId}"></c:out>' readonly>
                 </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">FULL NAME</label>
                    <input type="text" class="form-control" name="name" value='<c:out value="${customers.firstName} ${customers.lastName}"></c:out>' readonly>
                 </div>
              </div>
              <!-- /.col -->
              <div class="col-md-6">
    ...
    <input type="text" class="form-control" name="payStatus" value="${customers.payment.payStatus}" readonly />
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                <label >INVOICE </label>
            	<a href="./UserController?bookId=<c:out value="${customers.booking.bookId}"></c:out>&action=invoiceGet" class="btn btn-warning col cancel">
...
<form action="AdminController" method="post">
	<input type="hidden" name="bookId" value="<c:out value="${customers.booking.bookId }"/>">
  <div class="card card-default">
    <div class="card-header">
      <h3 class="card-title">VALIDATION ADMIN</h3>
      <div class="card-tools">
        <button type="button" class="btn btn-tool" data-card-widget="collapse">
          <i class="fas fa-minus"></i>
        </button>
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="form-group">
            ...
            <select class="form-control select2bs4" name="bookStatus" style="width: 100%;">
        ...
        <div class="col-md-6">
          <div class="form-group">
            ...
            <input type="text" class="form-control" name="remark" placeholder="REASON OF VALIDATION">
          </div>
