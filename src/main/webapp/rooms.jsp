                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <br><br><br>
                                <a href="./CampingController?type=<c:out value="${packages[0].packageId}"/>&action=package" class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <a href="./CampingController?id=<c:out value="${id.custId}"/>&type=<c:out value="${packages[1].packageId}"/>&action=package" class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <br><br><br>
                                <a href="./CampingController?id=<c:out value="${id.custId}"/>&type=<c:out value="${packages[2].packageId}"/>&action=package" class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <br><br>
                                <a href="./CampingController?id=<c:out value="${id.custId}"/>&type=<c:out value="${packages[3].packageId}"/>&action=package"  class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <br>
                                <a href="./CampingController?id=<c:out value="${id.custId}"/>&type=<c:out value="${packages[4].packageId}"/>&action=package" class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="room-item">
                            ...
                            <div class="ri-text">
                                ...
                                <br>
                               <a href="./CampingController?id=<c:out value="${id.custId}"/>&type=<c:out value="${packages[5].packageId}"/>&action=package"  class="primary-btn">Check Availability</a>
                            </div>
                        </div>
                    </div>
                </div>
