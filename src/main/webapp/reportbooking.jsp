...
<body class="hold-transition sidebar-mini">
            ...
            <div class="card">
              <div class="card-body">
                ...
                <div class="col-xs-8">
                  ...
                  <input type="text" class="form-control" id="myInput" onkeyup="myFunction()" placeholder="FILTER BY DATE" title="Type in a DD/MM/YYYY">
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                </div>
                  ...
                  <tr>
                   ...
                   <tbody>
					...
					<td><c:out value="${booking.packageName}"></c:out></td>
					<td><c:out value="RM ${booking.totalPrice}0"></c:out></td>
					<td><c:out value="${booking.payStatus}"></c:out></td>
  ...
  <footer class="main-footer">
    ...
    <strong>UITM KAMPUS JASIN MELAKA.</strong> All rights reserved.
  </footer>
